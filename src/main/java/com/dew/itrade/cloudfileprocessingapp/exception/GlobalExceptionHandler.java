package com.dew.itrade.cloudfileprocessingapp.exception;

import com.dew.itrade.cloudfileprocessingapp.constant.ApplicationConstant;
import com.dew.itrade.cloudfileprocessingapp.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleBadRequestException(ServiceException ex) {
        ...
        String errorMessage=ApplicationConstant.FILE_ALREADY_EXIST;
